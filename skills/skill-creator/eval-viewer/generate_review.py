...
def generate_html(
    ...
    # Prevent inline-script breakout: any "</" in embedded strings would close
    # the surrounding <script> tag prematurely. Escape to "<\/" which JSON
    # parsers normalize back to "</".
