---
name: pdf-publisher
description: Generate high-quality PDFs with professional typesetting. Create academic papers, reports, and documents using HTML+Paged.js with beautiful cover designs, KaTeX math formulas, Mermaid diagrams, three-line tables, and citations. Supports LaTeX compilation via Tectonic. Use this skill when the user wants to CREATE a well-designed PDF from scratch, not for processing existing PDFs.
---
